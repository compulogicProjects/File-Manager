...
public class SurahActivity extends AppCompatActivity implements AdapterListner, totaltime, com.example.quran.starttime {
    RecyclerView recyclerView;
    ListAdapter listAdapter;
    TextView ontitle, startime, endtime;
    ImageView btnstartstop, btnpre, btnnext;
    SeekBar seekBar;
    String[] suratname;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ontitle = findViewById(R.id.ontitle);
        startime = findViewById(R.id.textstart);
        endtime = findViewById(R.id.textstop);
        btnstartstop = findViewById(R.id.playpause);
        btnpre = findViewById(R.id.previous);
        btnnext = findViewById(R.id.next);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        suratname = new String[]{"Surah Al Fatihah", "Surah Al-Baqra", "Surah Al-Imran",
        ...
        listAdapter = new ListAdapter(suratname, suratnamemeaning, this,this,
                this,this);
    ...
    ontitle.setText(suratname[adapterPosition]);
    }

    @Override
    public void totaltime(int time) {
        String totaltime=createtime(time);
        endtime.setText(totaltime);
    }

    @Override
    public void starttime(int starttime1) {
        final Handler handler= new Handler();
        int delay=100;
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                String starttime=createtime(starttime1);
