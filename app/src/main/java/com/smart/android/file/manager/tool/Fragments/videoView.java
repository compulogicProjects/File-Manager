...
public class videoView extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        /*
        ScrollView frameLayout= view.findViewById(R.id.frameLayout);

        AppLovin.show(frameLayout);
...
*/
        ...
        videoView= view.findViewById(R.id.viewview);
        Bundle bundle= this.getArguments();
        position= bundle.getInt("imagepath",-1);
    ...
    public void playervideo(){
        ...
        videoView.setVideoPath(String.valueOf(VideoFragment.fileList.get(position)));
        ...
        videoView.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            ...
            public void onCompletion(MediaPlayer mp) {
              /*  position=position+1;
                ...
                Toast.makeText(getContext(), VideoFragment.fileList.size()+"", Toast.LENGTH_SHORT).show();

                if (position>VideoFragment.fileList.size()) {

                }
                else {
                    videoView.setVideoPath(String.valueOf(VideoFragment.fileList.
                            get(position)));
                    videoView.start();
                }*/
