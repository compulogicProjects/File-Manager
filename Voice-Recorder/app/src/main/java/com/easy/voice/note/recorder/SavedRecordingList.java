...
import com.easy.voice.note.recorder.ad.Ad_Helper;
...
public class SavedRecordingList extends AppCompatActivity implements DeleteClisckLisner{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout relativeLayout= findViewById(R.id.layad);
        Ad_Helper.loadMediationBannerAd(this,relativeLayout);
                    ...
                    builder.setTitle("Confirmation")
                            ...
                            .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    constany.constant=0;
                                    Ad_Helper.showIntersitial(SavedRecordingList.this);
            ...
            public void onClick(View view) {
                if (mediaPlayer != null) {
                  ...
                  /*  sharedPreferences= getSharedPreferences(TAG,MODE_PRIVATE);
                    ...
                    finish();
                    //.makeText(SavedRecordingList.this, "Finish before pref", Toast.LENGTH_SHORT).show();
                }
            }
        });
