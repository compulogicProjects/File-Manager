...
public class RecordingScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linearLayoutad=findViewById(R.id.layad);
        Ad_Helper.loadMediationBannerAd(this,linearLayoutad);
        getPermission();
        ...
        saveimage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ok.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        constany.constant=0;
                        Ad_Helper.showIntersitial(RecordingScreen.this);
                    ...
                    if(Build.VERSION.SDK_INT < 26) {
                        ...
                        cancel.setVisibility(View.VISIBLE);*/
                            ...
                            if (!startrecording) {
                                ...
                                titlerecording.setText("Recording........");
                                startrecording = true;
                               // Toast.makeText(RecordingScreen.this, startrecording+"", Toast.LENGTH_SHORT).show();
                            }
                        else if (pause) {
                            resume_rec();
                        } else {
